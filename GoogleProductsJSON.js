...
console.log("Go through the items and find all results that have kind of shopping#product. Print the count of these results. Where else is this count information stored in the search results?")
console.log(" ")

console.log ("Total items inside the object are : " + alyssaData.items.length);
for (var kindLoop2 in alyssaData.items)
{
  console.log(alyssaData.items[kindLoop2].kind)
}
console.log(" ")
console.log (" ----------------* SECOND PROBLEM -----------------------------------------------------------------------------")
console.log("Print the title all items with a backorder availability in inventories. ")
console.log(" ")


for (var boloop in alyssaData.items)
if (alyssaData.items[boloop].product.inventories[0].availability === 'backorder')
{
  console.log(alyssaData.items[boloop].product.inventories[0])
}
console.log(" ")
console.log (" ----------------* THIRD PROBLEM -----------------------------------------------------------------------------")
console.log("Print the title all items with more than one image link.")
console.log(" ")

for (var imgloop in alyssaData.items)
{
  if  (alyssaData.items[imgloop].product.images.length > 1)
        console.log(alyssaData.items[imgloop].product)
}

console.log(" ")
console.log (" ----------------* FOURTH PROBLEM -----------------------------------------------------------------------------")
console.log("Print all Canon products in the items (careful with case sensitivity).")
console.log(" ")

for (var canonLoop in alyssaData.items)
{ if (alyssaData.items[canonLoop].product.brand === 'Canon')
  console.log(alyssaData.items[canonLoop].product)
}

console.log(" ")
console.log (" ----------------* FIVTH PROBLEM -----------------------------------------------------------------------------")
console.log("Print all items that have an author name of eBay and are brand Canon.")
console.log(" ")

for (var authorAndBrandLoop in alyssaData.items)
{
  if (alyssaData.items[authorAndBrandLoop].product.author.name === 'eBay' 
  && alyssaData.items[authorAndBrandLoop].product.brand === 'Canon')
  console.log(alyssaData.items[authorAndBrandLoop].product)
}

console.log(" ")
console.log (" ----------------* SIXTH PROBLEM -----------------------------------------------------------------------------")
console.log("Print all the products with their brand, price, and an image link ")
console.log(" ")

for (var bpiLoop in alyssaData.items)
{
console.log(alyssaData.items[bpiLoop].product.brand)
console.log(alyssaData.items[bpiLoop].product.inventories[0].price)
console.log(alyssaData.items[bpiLoop].product.images[0])
}

console.log(" 'Problem solved by Ahmed Abdelraouf' :) Lol");